...
This project uses a **txAdmin recipe** for simplified setup, resource management, and deployment.  

👉 **To get started**, visit the official txAdmin recipe repository:  
🔗 [HadesStudios/txAdminRecipe](https://github.com/HadesStudios/txAdminRecipe)
...
🔍 [HadesStudios GitHub Repositories](https://github.com/orgs/HadesStudios/repositories)
...
- [Discord Link](https://discord.gg/cKvb9FQEwv) - Offical Discord for Hades Framework community-driven support forum!

## Project Maintainers

- Koopa - Community Owner
- Seeth - Community Owner
- Leigton - Community Owner

## Credits

- Alzar & Dr Nick - Original Brains
...
This is a map list used by **Hades Framework** for business, government ect.
...
- [nopixel_hospital](https://store.nopixel.net/)
- [nopixel MRPD](https://store.nopixel.net/)
